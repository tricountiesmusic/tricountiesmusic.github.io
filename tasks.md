...
# make forms send to mareepg@gmail.com
# make radio labels select radio button when clicked

###### Maybes

# style, add nice images of instruments to other pages
# make judges sheets automatically when someone submits the form ??? how though
# make paypal buttons return person to a thank you page
